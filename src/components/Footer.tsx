        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            <div className="flex items-center space-x-3 mb-4">
              <div className="bg-yellow-400 text-slate-900 font-bold text-xl px-3 py-2 rounded">
                CH
              </div>
              <div>
                <div className="font-bold text-xl">Premier Services</div>
                <div className="text-sm text-gray-300">Luxury • Reliability • Excellence</div>
              </div>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/services/limo" className="text-gray-300 hover:text-white transition-colors">Luxury Limousines</Link></li>
              <li><Link to="/services/boat-charters" className="text-gray-300 hover:text-white transition-colors">Boat Charters</Link></li>
