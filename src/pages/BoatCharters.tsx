  ...
  return (
    <div className="pt-24">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-slate-900 mb-4">Why Choose Our Charter Service?</h2>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-slate-900 mb-4">Our Charter Services</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-slate-900 mb-4">Our Luxury Fleet</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {fleet.map((vessel, index) => (
              <div key={index} className="bg-gray-50 rounded-xl overflow-hidden shadow-lg hover:shadow-xl transition-all">
                ...
                />
                <div className="p-6">
                  <h3 className="text-xl font-semibold text-slate-900 mb-2">{vessel.name}</h3>
                  <p className="text-yellow-600 font-medium mb-4">{vessel.capacity}</p>
                  <ul className="space-y-2">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-slate-800 rounded-xl p-8 text-center">
              ...
              <div className="text-4xl font-bold text-yellow-400 mb-4">$800</div>
              <p className="text-gray-300 mb-6">3-hour cruise (up to 8 guests)</p>
              <ul className="space-y-2 text-left">
                <li className="flex items-center"><Compass className="w-4 h-4 text-yellow-400 mr-2" />Scenic coastal route</li>
                <li className="flex items-center"><Camera className="w-4 h-4 text-yellow-400 mr-2" />Photo opportunities</li>
                <li className="flex items-center"><Star className="w-4 h-4 text-yellow-400 mr-2" />Champagne service</li>
              </ul>
            </div>
            ...
            <div className="bg-slate-800 rounded-xl p-8 text-center">
              ...
              <div className="text-4xl font-bold text-yellow-400 mb-4">$2,000</div>
              <p className="text-gray-300 mb-6">8-hour charter (up to 15 guests)</p>
              <ul className="space-y-2 text-left">
                <li className="flex items-center"><Waves className="w-4 h-4 text-yellow-400 mr-2" />Extended cruising</li>
                <li className="flex items-center"><Users className="w-4 h-4 text-yellow-400 mr-2" />Multiple activities</li>
                <li className="flex items-center"><Clock className="w-4 h-4 text-yellow-400 mr-2" />Flexible itinerary</li>
              </ul>
            </div>
          </div>
